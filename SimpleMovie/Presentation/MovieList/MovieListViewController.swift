...
class MovieListViewController: UIBaseViewController, ViewModelProtocol {
    ...
    // MARK: - Properties
    private let actionRelay = PublishRelay<MovieListActionType>()
    ...
    func bindingViewModel() {
        ...
        subView.setupDI(observable: res.movieList)
    }
    
    // MARK: - View
    let subView = MovieListView()
